...
from sample.logger import init_logger

from sample.cli.version import version_command
from sample.cli.greet import greet_command
...
def cli_frontend(ctx, verbose):
    """
    Sample tool for sveetch-python-sample
    """
    printout = True
    if verbose == 0:
        verbose = 1
